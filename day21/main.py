# https://www.reddit.com/r/adventofcode/comments/7l78eb/2017_day_21_solutions/drk4nrz/
...
for t in range(19):
    ...
    for r in range(n // block_size):
        ...
        for c in range(n // block_size):
            block_in = tuple(
                [tuple([pattern[r * block_size + rr][c * block_size + cc] for cc in range(block_size)]) for rr in
                 range(block_size)])
